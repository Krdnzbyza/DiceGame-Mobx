...
mixin _$DiceGameViewModel on _DiceGameViewModelBase, Store {
  ...
  final _$leftAtom = Atom(name: '_DiceGameViewModelBase.left');
  ...
  final _$rightAtom = Atom(name: '_DiceGameViewModelBase.right');
  ...
  final _$_DiceGameViewModelBaseActionController =
      ActionController(name: '_DiceGameViewModelBase');
